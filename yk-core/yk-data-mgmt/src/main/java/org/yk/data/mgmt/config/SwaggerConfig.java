package org.yk.data.mgmt.config;
...
public class SwaggerConfig {
	...
	public Docket swaggerSpringMvcPlugin() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).genericModelSubstitutes(DeferredResult.class)
				...
				.apis(RequestHandlerSelectors.basePackage("org.yk.data.mgmt.controller")).paths(PathSelectors.any())
				.build();
	}

	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("datas mgmt").description("yk-cloud Platform  API")
